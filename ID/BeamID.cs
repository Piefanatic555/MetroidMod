...
namespace MetroidMod.ID
{
	public static class BeamID
	{
		...
		public enum Beam 
		{
			[Util.ItemID(ModContent.ItemType<ChargeBeamAddon>()), Util.Version(1), Util.Slot(SlotType.Charge)]
			Charge,
			[Util.ItemID(ModContent.ItemType<V2.ChargeBeamV2Addon>()), Util.Version(2), Util.Slot(SlotType.Charge)]
			ChargeV2,
			[Util.ItemID(ModContent.ItemType<V3.LuminiteBeamAddon>()), Util.Version(3), Util.Slot(SlotType.Charge)]
			Luminite,
			[Util.ItemID(ModContent.ItemType<HyperBeamAddon>()), Util.Version(0), Util.Slot(SlotType.Charge)]
			Hyper,
			[Util.ItemID(ModContent.ItemType<PhazonBeamAddon>()), Util.Version(0), Util.Slot(SlotType.Charge)]
			Phazon,
			[Util.ItemID(ModContent.ItemType<Hunters.BattleHammerAddon>()), Util.Version(0), Util.Slot(SlotType.Charge)]
			BattleHammer,
			[Util.ItemID(ModContent.ItemType<Hunters.ImperialistAddon>()), Util.Version(0), Util.Slot(SlotType.Charge)]
			Imperialist,
			[Util.ItemID(ModContent.ItemType<Hunters.JudicatorAddon>()), Util.Version(0), Util.Slot(SlotType.Charge)]
			Judicator,
			[Util.ItemID(ModContent.ItemType<Hunters.MagMaulAddon>()), Util.Version(0), Util.Slot(SlotType.Charge)]
			Magmaul,
			[Util.ItemID(ModContent.ItemType<Hunters.ShockCoilAddon>()), Util.Version(0), Util.Slot(SlotType.Charge)]
			ShockCoil,
			[Util.ItemID(ModContent.ItemType<Hunters.VoltDriverAddon>()), Util.Version(0), Util.Slot(SlotType.Charge)]
			VoltDriver,
			[Util.ItemID(ModContent.ItemType<Hunters.OmegaCannonAddon>()), Util.Version(0), Util.Slot(SlotType.Charge)]
			OmegaCannon,
			[Util.ItemID(ModContent.ItemType<WaveBeamAddon>()), Util.Version(1), Util.Slot(SlotType.Utility)]
			Wave,
			[Util.ItemID(ModContent.ItemType<V2.WaveBeamV2Addon>()), Util.Version(2), Util.Slot(SlotType.Utility)]
			WaveV2,
			[Util.ItemID(ModContent.ItemType<V3.NebulaBeamAddon>()), Util.Version(3), Util.Slot(SlotType.Utility)]
			Nebula,
			[Util.ItemID(ModContent.ItemType<SpazerAddon>()), Util.Version(1), Util.Slot(SlotType.PrimaryA)]
			Spazer,
			[Util.ItemID(ModContent.ItemType<V2.WideBeamAddon>()), Util.Version(2), Util.Slot(SlotType.PrimaryA)]
			Wide,
			[Util.ItemID(ModContent.ItemType<V3.VortexBeamAddon>()), Util.Version(3), Util.Slot(SlotType.PrimaryA)]
			Vortex,
			[Util.ItemID(ModContent.ItemType<PlasmaBeamRedAddon>()), Util.Version(2), Util.Slot(SlotType.PrimaryB)]
			PlasmaR,
			[Util.ItemID(ModContent.ItemType<PlasmaBeamGreenAddon>()), Util.Version(2), Util.Slot(SlotType.PrimaryB)]
			PlasmaG,
			[Util.ItemID(ModContent.ItemType<V2.NovaBeamAddon>()), Util.Version(2), Util.Slot(SlotType.PrimaryB)]
			Nova,
			[Util.ItemID(ModContent.ItemType<V3.SolarBeamAddon>()), Util.Version(3), Util.Slot(SlotType.PrimaryB)]
			Solar,
			[Util.ItemID(ModContent.ItemType<IceBeamAddon>()), Util.Version(1), Util.Slot(SlotType.Secondary)]
			Ice,
			[Util.ItemID(ModContent.ItemType<V2.IceBeamV2Addon>()), Util.Version(2), Util.Slot(SlotType.Secondary)]
			IceV2,
			[Util.ItemID(ModContent.ItemType<V3.StardustBeamAddon>()), Util.Version(3), Util.Slot(SlotType.Secondary)]
			Stardust
		}
	}
}
